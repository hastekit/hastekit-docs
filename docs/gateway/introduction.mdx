---
title: "Introduction"
description: "HasteKit LLM Gateway & Agent Builder - A high-performance LLM gateway & no-code agent builder"
---
...
- **Virtual Keys**: Protect your provider API keys by using HasteKit-generated virtual keys in your client applications
...
HasteKit Gateway provides two primary capabilities:
...
Beyond proxying LLM calls, HasteKit Gateway includes a complete no-code agent builder. Define model parameters, system prompts, MCP tool servers, and output schemas—all from the dashboard, without writing code.
...
HasteKit Gateway currently supports OpenAI, Anthropic, and Gemini. Support for additional providers is on the roadmap.
