...
description: Learn how to start HasteKit gateway in development mode for local development.
---

This guide will help you set up HasteKit Gateway for local development. In development mode, you'll run the backend and frontend locally while using Docker Compose for infrastructure services.
...
Clone the HasteKit gateway repository:

```bash
git clone https://github.com/hastekit/hastekit-ai-gateway.git
cd hastekit-ai-gateway
```
