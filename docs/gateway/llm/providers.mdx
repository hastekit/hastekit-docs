...
The Providers page allows you to configure and manage LLM providers for the HasteKit LLM Gateway. You can add API keys, configure base URLs, set custom headers, and use environment variables for secure key management.

![Providers Overview](../../images/llm/providers.png)
...
![Edit Provider Configuration](../../images/llm/custom-headers.png)
...
![Add API Key Dialog](../../images/llm/add-api-keys.png)
...
**Note:** The environment variable must be set in the environment where the HasteKit LLM Gateway is running. The gateway reads environment variables at runtime when processing requests.
