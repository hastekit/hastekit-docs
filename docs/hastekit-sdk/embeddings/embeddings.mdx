...
| **ExtraFields** | `map[string]any` | Optional. Provider-specific extra fields merged into the request payload. |
...
| Field | Type | Description |
| :--- | :--- | :--- |
| **Object** | `string` | Object type identifier for the embedding entry. |
