...
resp, err := model.NewTranscription(context.Background(), &transcription.Request{
    Audio:         audio,
...
| **Raw** | `map[string]any` | Raw provider response fields. |
...
func main() {
    ...
    model := client.Model("OpenAI/whisper-1")
