...
| **Instruction** | `agents.SystemPromptProvider` | System prompt defining agent behavior (use `client.Prompt()` for simple strings) |
...
| **Runtime** | `agents.Runtime` | Optional durable execution runtime (see the [Durable Execution](/hastekit-sdk/agents/durable/restate) pages) |
