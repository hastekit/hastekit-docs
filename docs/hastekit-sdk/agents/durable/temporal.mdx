...
See the complete working example in the repository: [`examples/agents/9_temporal_agent/main.go`](https://github.com/hastekit/hastekit-docs/tree/main/examples/agents/9_temporal_agent)
