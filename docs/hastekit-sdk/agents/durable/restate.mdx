...
See the complete working example in the repository: [`examples/13_durable_agent/main.go`](https://github.com/curaious/uno/tree/main/examples/13_durable_agent)
